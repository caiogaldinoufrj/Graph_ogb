...
def argument():
    ...
    parser.add_argument('--save_dir', type=str, default='truly_ablation/all_no_temporal_randomwalk_truly_aadc', help='Directory to save checkpoints and logs')
    ...
    parser.add_argument('--use_heuristic', type=str2bool, default=True, help="Injeta a heurística AA no preditor")
